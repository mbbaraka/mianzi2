...
} elseif ($_instance->childHasBeenRendered('YcEBwXQ')) {
    $componentId = $_instance->getRenderedChildComponentId('YcEBwXQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('YcEBwXQ');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YcEBwXQ');
} else {
    $response = \Livewire\Livewire::mount('search');
    $dom = $response->dom;
    $_instance->logRenderedChild('YcEBwXQ', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                        </div>
