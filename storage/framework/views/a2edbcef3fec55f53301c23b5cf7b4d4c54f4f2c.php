<header class="site__header d-lg-block d-none">
                                    ...
                                    <div class="dropcart">
                                       <div class="dropcart__products-list">
                                          ...
                                          <div class="dropcart__product">
                                             ...
                                             <a href="<?php echo e(route('cart.destroy', $carts->__raw_id)); ?>" class="dropcart__product-remove btn btn-light btn-sm">
                                                <i style="width: 10px; height: 10px;" class="fa fa-times"></i>
                                             </a>
                                          </div>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         ...
         </header><?php /**PATH C:\xampp\htdocs\mianzi2\resources\views/layouts/partials/home/header-1.blade.php ENDPATH**/ ?>