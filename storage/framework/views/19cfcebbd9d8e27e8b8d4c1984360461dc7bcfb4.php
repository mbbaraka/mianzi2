<!-- .block-features / end --><!-- .block-products-carousel -->
               ...
               <div class="container">
                  <div class="block-header">
                     ...
                     <ul class="block-header__groups-list">
                        <li><button type="button" class="block-header__group block-header__group--active">View All</button></li>
                  ...
                  <div class="block-products-carousel__slider">
                      <div class="owl-carousel">
                      	<?php $__currentLoopData = Products::get('latest'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            </div><?php /**PATH C:\xampp\htdocs\mianzi2\resources\views/home/home/new.blade.php ENDPATH**/ ?>