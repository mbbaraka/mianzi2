                           ...
                           <div class="block-products-carousel__column">
                              <div class="block-products-carousel__cell">
                                 <div class="product-card">
                                    ...
                                    <div class="product-card__image"><a href="<?php echo e(url($product->slug.'.html')); ?>"><img style="width: 180px; height: 180px;" src="<?php echo e(asset('app/product/'.$product->cover)); ?>" alt="<?php echo e($product->title); ?>"></a></div>
                        ...
                        <?php $__currentLoopData = Products::recent($session, $product->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <div class="products-list__item">
                                 <div class="product-card">
                                    ...
                                    <div class="product-card__image"><a href="<?php echo e(url($product->product->slug.'.html')); ?>"><img style="width: 180px; height: 180px;" src="<?php echo e(asset('app/product/'.$product->product->cover)); ?>" alt="<?php echo e($product->product->title); ?>"></a></div>
                                    <div class="product-card__info">
            ...
            </div><?php /**PATH C:\xampp\htdocs\mianzi2\resources\views/home/product/recent-views.blade.php ENDPATH**/ ?>