...
} elseif ($_instance->childHasBeenRendered('DJWekLn')) {
    $componentId = $_instance->getRenderedChildComponentId('DJWekLn');
    $componentTag = $_instance->getRenderedChildComponentTagName('DJWekLn');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DJWekLn');
} else {
    $response = \Livewire\Livewire::mount('search');
    $dom = $response->dom;
    $_instance->logRenderedChild('DJWekLn', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                     </div>
